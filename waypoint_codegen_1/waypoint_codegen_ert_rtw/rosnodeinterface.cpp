...
//
// Code generated for Simulink model 'waypoint_codegen'.
//
// Model version                  : 1.40
// Simulink Coder version         : 24.2 (R2024b) 21-Jun-2024
// C/C++ source code generated on : Fri Sep 05 01:01:17 2025
//
...
#define ROS_SET_RTM_ERROR_STATUS(status) rtmSetErrorStatus(waypoint_codegen_M,(status));
#define ROS_GET_RTM_ERROR_STATUS()     rtmGetErrorStatus(waypoint_codegen_M)
#define ROS_RTM_STEP_TASK(id)          rtmStepTask(waypoint_codegen_M,id)
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"waypoint_codegen\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        ROS_SET_RTM_ERROR_STATUS(NULL);
        waypoint_codegen_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(ROS_GET_RTM_ERROR_STATUS()
                == (NULL)) || rtmGetStopRequested(waypoint_codegen_M));
