...
#define ROS_SET_RTM_ERROR_STATUS(status) rtmSetErrorStatus(greenhouseHoverTest_M,(status));
#define ROS_GET_RTM_ERROR_STATUS()     rtmGetErrorStatus(greenhouseHoverTest_M)
#define ROS_RTM_STEP_TASK(id)          rtmStepTask(greenhouseHoverTest_M,id)
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"greenhouseHoverTest\" **\n");
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(ROS_GET_RTM_ERROR_STATUS()
                == (NULL)) || rtmGetStopRequested(greenhouseHoverTest_M));
